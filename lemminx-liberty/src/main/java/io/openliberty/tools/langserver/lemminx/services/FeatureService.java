...
public class FeatureService {
    ...
    private static final String FEATURELIST_XML_RESOURCE_URL = "https://github.com/OpenLiberty/liberty-language-server/blob/master/lemminx-liberty/src/main/resources/featurelist-cached-25.0.0.1.xml";
    private static final String FEATURELIST_XML_CLASSPATH_LOCATION = "/featurelist-cached-25.0.0.1.xml";
    ...
    private FeaturesAndPlatforms getDefaultFeaturesAndPlatforms() {
        try {
            if (defaultFeaturesAndPlatforms == null) {
                ...
                InputStream is = getClass().getClassLoader().getResourceAsStream("features-cached-25.0.0.1.json");
